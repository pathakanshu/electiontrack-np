...
export interface ElectionConfig {
  ...
  endpoints: {
    ...
    // Lookup endpoints - fetch identifiers with names
    // Live from Election Commission API
    districtLookup: string;

    // Cache endpoints - served from public/cache/ directory
    // Generated by scripts/download-cache.ts from candidates data
...
export const ELECTIONS: Record<string, ElectionConfig> = {
  '2079': {
    ...
    endpoints: {
      ...
      // Live lookup for district names and province IDs
      districtLookup:
        'https://result.election.gov.np/JSONFiles/Election2079/Local/Lookup/districts.json',

      // Cached locally (generated by download-cache.ts)
  ...
  //       `https://result.election.gov.np/JSONFiles/JSONMap/geojson/Const/dist-${districtId}.json`,
  //     districtLookup:
  //       "https://result.election.gov.np/JSONFiles/Election2074/Local/Lookup/districts.json",
